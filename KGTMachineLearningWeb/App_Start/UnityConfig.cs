using KGTMachineLearningWeb.Config;
...
namespace KGTMachineLearningWeb
{
    ...
    public static class UnityConfig
    {
        ...
        {
            //Register user managers
            container.RegisterType<AccountController>(new InjectionConstructor(typeof(ICategoryDomain)));
            ...
            DependencyInjection.RegisterDependencies(container);
        }
    }
}