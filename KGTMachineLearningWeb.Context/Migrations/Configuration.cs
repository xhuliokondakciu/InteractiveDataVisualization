...
{
    using KGTMachineLearningWeb.Common;
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<KGTMachineLearningWeb.Context.KGTContext>
    {
        ...
        public Configuration()
        {
            ...
            ContextKey = "KGTMachineLearningWeb.Context.KGTContext";
        }

        protected override void Seed(KGTContext context)
        {
            CreateUsers(context);
        ...
        private void AddChartImage(KGTContext context)
        {
            var chart1 = context.ChartObjects.ToList().ElementAt(0);
            chart1.Thumbnail.SetThumbnailImage(@"C:\Users\Xhulio\source\Diploma\mlguiplayground\KGTMachineLearningWeb\Content\icons\line-chart-96.png");
            context.ChartObjects.AddOrUpdate(chart1);

            var chart2 = context.ChartObjects.ToList().ElementAt(1);
            chart2.Thumbnail.SetThumbnailImage(@"C:\Users\Xhulio\source\Diploma\mlguiplayground\KGTMachineLearningWeb\Content\icons\line-chart-96.png");
            context.ChartObjects.AddOrUpdate(chart2);
            context.SaveChanges();
        }

        private void CreateUsers(KGTContext context)
        {
        ...
        private List<IdentityRole> CreateUserRoles(KGTContext context)
        {
